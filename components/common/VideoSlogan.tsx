    ...
    <div className="container mx-auto p-4">
      <div className="mb-12 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-4 ">
          SLOGAN VIDEOS OF OUR TEAM
        </h2>

        <p className="text-base text-[#4a5a4a] max-w-2xl  mx-auto text-center">
          We believe real change begins when young people take action for the
          planet. Driven by passion and purpose, we are restoring nature and
          building climate resilient communities. Together with the youth, we
          have planted trees in Mangochi, Lilongwe, and Mzuzu to protect our
          environment for future generations. Each tree represents hope,
          responsibility, and a commitment to sustainability. This is our
          journey led by youth, rooted in action, and growing a greener
          tomorrow.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {videoData.map((video) => (
          <div
            key={video.id}
            className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 hover:scale-105 transition-transform duration-300 rounded-lg"
          >
            <video
